            ...
            <Modal.Body>
                <Form onSubmit={onFormSubmit}>
                    <Form.Group className="mb-3" controlId="formTownName">
                        ...
                        <Form.Control onChange={onTownInput} value={town} placeholder="Enter Town Name" />
                    </Form.Group>
                    <Form.Group className="mb-3" controlId="formRegionName">
                        <Form.Label>Region Name</Form.Label>
                        <Form.Control onChange={onRegionInput} value={region} placeholder="Enter Region Name" />
                    </Form.Group>
                    <Form.Group>
                        <Button className="mx-1" type="submit">Save</Button>
                        <Button className="mx-1" onClick={props.onHide}>Close</Button>
                    </Form.Group>
                </Form>
            </Modal.Body>
        </Modal>
