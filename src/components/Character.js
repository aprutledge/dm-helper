...
export const Character = (props) => {
    return (
        <Card id={props.id} className={`col-12 col-sm-6 col-md-6 col-lg-4 mx-2 mb-5`}
            style={{ width: '18rem' }}>
            <Card.Body>
                <Card.Title>{props.char.name}</Card.Title>
                <Card.Subtitle className="mb-2 text-muted">{"A " + props.char.race + " " + props.char.class + "."}</Card.Subtitle>
                <Card.Text>
